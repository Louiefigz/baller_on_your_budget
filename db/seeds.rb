...
Friendship.create(user_id: user_1.id, friend_id: user_4.id)
Friendship.create(user_id: user_1.id, friend_id: user_5.id)
Friendship.create(user_id: user_2.id, friend_id: user_5.id)
Friendship.create(user_id: user_2.id, friend_id: user_4.id)
Friendship.create(user_id: user_2.id, friend_id: user_3.id)
Friendship.create(user_id: user_3.id, friend_id: user_4.id)
Friendship.create(user_id: user_3.id, friend_id: user_5.id)
